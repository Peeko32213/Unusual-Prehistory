...
public class InstrumentTagsGenerator extends TagsProvider<Instrument> {
    ...
    public InstrumentTagsGenerator(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pLookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
