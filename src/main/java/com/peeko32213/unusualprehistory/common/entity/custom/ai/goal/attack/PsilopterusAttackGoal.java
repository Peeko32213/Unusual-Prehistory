...
public class PsilopterusAttackGoal extends Goal {
    ...
    protected void preformKickAttack () {
        this.mob.setDeltaMovement(this.mob.getDeltaMovement().scale(0));
        HitboxAttacks.pivotedPolyHitCheck(mob, this.mob, this.biteOffSet, 0.6, 1, 1.0, (ServerLevel)this.mob.level(), (float) mob.getAttribute(Attributes.ATTACK_DAMAGE).getValue(), (this.mob.damageSources().mobAttack(mob)), 0.25F, false, true, false);
    }
