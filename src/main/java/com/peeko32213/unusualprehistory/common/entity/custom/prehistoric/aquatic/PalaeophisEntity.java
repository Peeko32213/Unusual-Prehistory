...
public class PalaeophisEntity extends PrehistoricAquaticEntityOld implements GeoAnimatable {
    ...
    private static final EntityDataAccessor<Optional<UUID>> CHILD_UUID = SynchedEntityData.defineId(PalaeophisEntity.class, EntityDataSerializers.OPTIONAL_UUID);
    private static final EntityDataAccessor<Integer> CHILD_ID = SynchedEntityData.defineId(PalaeophisEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> SHEDDING_TIME = SynchedEntityData.defineId(PalaeophisEntity.class, EntityDataSerializers.INT);
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public final float[] ringBuffer = new float[64];
    public int ringBufferIndex = -1;
    private int sheddingCooldown = 0;
    private PalaeophisPartEntity[] parts;
    ...
    public PalaeophisEntity(EntityType<? extends PrehistoricAquaticEntityOld> entityType, Level level) {
        ...
        this.moveControl = new PalaeophisEntity.MoveHelperController(this);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new PalaeophisEntity.DunkMeleeAttackGoal(this, 2F, true));
    ...
    public void pushEntities() {
        ...
        entities.stream().filter(entity -> !(entity instanceof PalaeophisPartEntity) && entity.isPushable()).forEach(entity -> entity.push(this));
    }
    ...
    public void tick() {
        ...
        if(!this.level().isClientSide){
            ...
            if (child == null) {
                ...
                parts = new PalaeophisPartEntity[segments];
                ...
                for (int i = 0; i < segments; i++) {
                    ...
                    PalaeophisPartEntity part = new PalaeophisPartEntity(UPEntities.PALAEOPHIS_PART.get(), this);
                    ...
                    if (partParent instanceof PalaeophisPartEntity) {
                        ((PalaeophisPartEntity) partParent).setChildId(part.getUUID());
                    }
            ...
            if (shouldReplaceParts() && this.getChild() instanceof PalaeophisPartEntity) {
                parts = new PalaeophisPartEntity[segments];
                parts[0] = (PalaeophisPartEntity) this.getChild();
                this.entityData.set(CHILD_ID, parts[0].getId());
                int i = 1;
                while (i < parts.length && parts[i - 1].getChild() instanceof PalaeophisPartEntity) {
                    parts[i] = (PalaeophisPartEntity) parts[i - 1].getChild();
                    i++;
                }
            }
            PalaeophisPartIndex partIndex = PalaeophisPartIndex.HEAD;
...
//
    ...
    protected <E extends PalaeophisEntity> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
    ...
    static class MoveHelperController extends MoveControl {
        private final PalaeophisEntity dolphin;

        public MoveHelperController(PalaeophisEntity dolphinIn) {
            super(dolphinIn);
    ...
    static class DunkMeleeAttackGoal extends Goal {
        ...
        protected final PalaeophisEntity mob;
        ...
        public DunkMeleeAttackGoal(PalaeophisEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
            this.mob = p_i1636_1_;
