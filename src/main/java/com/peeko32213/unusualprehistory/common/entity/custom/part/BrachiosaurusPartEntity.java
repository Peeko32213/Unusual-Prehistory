...
public class BrachiosaurusPartEntity extends PartEntity<BrachiosaurusEntity> {

    private final EntityDimensions size;
    public float scale = 1;

    public BrachiosaurusPartEntity(BrachiosaurusEntity parent, float sizeX, float sizeY) {
        super(parent);
        this.size = EntityDimensions.scalable(sizeX, sizeY);
        this.refreshDimensions();
    }

    public BrachiosaurusPartEntity(BrachiosaurusEntity entityBrachiosaurus, float sizeX, float sizeY, EntityDimensions size) {
