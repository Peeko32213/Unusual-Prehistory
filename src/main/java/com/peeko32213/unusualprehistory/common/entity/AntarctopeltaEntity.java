...
import com.peeko32213.unusualprehistory.common.entity.msc.util.interfaces.ICustomAnimationsEntity;
...
public class AntarctopeltaEntity extends BaseDinosaurAnimalEntity implements ICustomAnimationsEntity {
    ...
    public AntarctopeltaEntity(EntityType<? extends Animal> entityType, Level level) {
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(1, new AntarctopeltaEntity.AntarcoMeleeAttackGoal(this,  2.5F, true));
    ...
    static class AntarcoMeleeAttackGoal extends Goal {
        ...
        protected final AntarctopeltaEntity mob;
        ...
        public AntarcoMeleeAttackGoal(AntarctopeltaEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
            this.mob = p_i1636_1_;
