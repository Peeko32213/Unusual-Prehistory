 ...
 public class OphiodonEntity extends PrehistoricAquaticEntityOld implements GeoAnimatable, IBookEntity {
     ...
     private static final EntityDataAccessor<Boolean> FROM_BOOK = SynchedEntityData.defineId(OphiodonEntity.class, EntityDataSerializers.BOOLEAN);
     ...
     private static final RawAnimation OPHIODON_ATTACK = RawAnimation.begin().thenLoop("animation.ophiodon.attack");
     private static final RawAnimation OPHIODON_BEACHED = RawAnimation.begin().thenLoop("animation.ophiodon.flop");
     ...
     protected void registerGoals() {
         ...
         this.goalSelector.addGoal(1, new OphiodonEntity.OphiodonMeleeAttackGoal(this, 2F, true));
         ...
         if(!this.isFromBook()) {
             ...
             switch (animState) {
                 ...
                 default:
                     ...
                     if (!this.isInWater()) {
                         event.setAndContinue(OPHIODON_BEACHED);
     ...
     static class MoveHelperController extends MoveControl {
         private final OphiodonEntity dolphin;

         public MoveHelperController(OphiodonEntity dolphinIn) {
             super(dolphinIn);
     ...
     static class OphiodonMeleeAttackGoal extends Goal {
         ...
         protected final OphiodonEntity mob;
         ...
         public OphiodonMeleeAttackGoal(OphiodonEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
             this.mob = p_i1636_1_;
