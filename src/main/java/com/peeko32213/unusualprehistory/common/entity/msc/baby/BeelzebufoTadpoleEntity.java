...
public class BeelzebufoTadpoleEntity extends AbstractFish implements GeoAnimatable {
    ...
    private int age;
    public BeelzebufoTadpoleEntity(EntityType<? extends AbstractFish> entityType, Level level) {
    ...
    private void growUp() {
        if (this.level() instanceof ServerLevel server) {
            BeelzebufoEntity frog = UPEntities.BEELZ.get().create(this.level());
            if (frog == null) return;
    ...
    protected <E extends BeelzebufoTadpoleEntity> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
        if (event.isMoving()) {
    ...
    public static boolean checkSurfaceWaterDinoSpawnRules(EntityType<? extends BeelzebufoTadpoleEntity> pWaterAnimal, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
