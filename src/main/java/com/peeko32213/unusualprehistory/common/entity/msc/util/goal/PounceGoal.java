...
public class PounceGoal extends Goal {
    ...
    protected BaseDinosaurAnimalEntity entity;
    protected LivingEntity target;
    protected int ticks;
    private int chargeTime;
    protected int timer;
    public PounceGoal(BaseDinosaurAnimalEntity entity, int chargeTime) {
    ...
    public void pounce(){
        ...
        Vec3 diff = new Vec3(this.target.getX() - this.entity.getX(), (this.target.getY() - this.entity.getY()) + 1.25, this.target.getZ() -this.entity.getZ());
