...
public class PalaeolophisHatchlingEntity extends BaseAquaticAnimalEntity implements GeoAnimatable, Bucketable, IVariantEntity {
    ...
    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(PalaeolophisHatchlingEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    private int age;
    public PalaeolophisHatchlingEntity(EntityType<? extends BaseAquaticAnimalEntity> entityType, Level level) {
        super(entityType, level);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        this.moveControl = new PalaeolophisHatchlingEntity.MoveHelperController(this);
    }
    ...
    private void growUp() {
        if (this.level() instanceof ServerLevel server) {
            PalaeophisEntity frog = UPEntities.PALAEOPHIS.get().create(this.level());
            if (frog == null) return;
    ...
    static class MoveHelperController extends MoveControl {
        private final PalaeolophisHatchlingEntity dolphin;

        public MoveHelperController(PalaeolophisHatchlingEntity dolphinIn) {
            super(dolphinIn);
    ...
    protected <E extends PalaeolophisHatchlingEntity> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
