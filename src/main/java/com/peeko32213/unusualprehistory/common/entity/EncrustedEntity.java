...
public class EncrustedEntity extends RangedMeleeMob implements GeoAnimatable, IBookEntity {
    ...
    public EncrustedEntity(EntityType<? extends RangedMeleeMob> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new CustomRangedAttackGoal(this, new RangedAttack(this)
                        ...
                        1.1D));
        this.goalSelector.addGoal(2, new EncrustedEntity.IMeleeAttackGoal());
    ...
    class IMeleeAttackGoal extends MeleeAttackGoal {
        public IMeleeAttackGoal() {
            super(EncrustedEntity.this, 1.6D, true);
        }
    ...
    private <E extends EncrustedEntity> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
        if(this.isFromBook()){
    ...
    protected <E extends EncrustedEntity> PlayState Attack(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
    ...
    protected <E extends EncrustedEntity> PlayState Shoot(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
