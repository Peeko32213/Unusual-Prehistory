...
public class EntityBabyDunk extends AbstractFish implements GeoAnimatable {
    ...
    private int age;
    private static final RawAnimation BABY_SWIM = RawAnimation.begin().thenLoop("animation.babydunk.swim");
