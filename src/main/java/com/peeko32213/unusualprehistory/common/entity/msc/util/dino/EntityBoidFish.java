...
import com.peeko32213.unusualprehistory.common.entity.msc.util.goal.boids.BoidFishSchoolingGoal;
import com.peeko32213.unusualprehistory.common.entity.msc.util.goal.boids.HeightBoundsGoal;
import com.peeko32213.unusualprehistory.common.entity.msc.util.goal.boids.LimitSpeedAndLookInVelocityDirectionGoal;
import com.peeko32213.unusualprehistory.common.entity.msc.util.goal.boids.OrganizeBoidSchoolingGoal;
...
public abstract class EntityBoidFish extends AbstractFish {
    @Nullable
    public EntityBoidFish leader;
    public List<EntityBoidFish> ownSchool = new ArrayList<>();

    public EntityBoidFish(EntityType<? extends AbstractFish> entityType, Level level) {
    ...
    public void startFollowing(EntityBoidFish abstractSchoolingFish) {
    ...
    private void addToOwnSchoolFollower(EntityBoidFish entity) {
        this.ownSchool.add(entity);
    }

    private void removeFollowerFromOwnSchool(EntityBoidFish entity) {
    ...
    public void addFollowers(Stream<? extends EntityBoidFish> stream) {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor serverLevelAccessor, DifficultyInstance difficultyInstance, MobSpawnType mobSpawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag compoundTag) {
        ...
        if (spawnGroupData == null) {
            spawnGroupData = new EntityBoidFish.SchoolSpawnGroupData(this);
        } else {
            this.startFollowing(((EntityBoidFish.SchoolSpawnGroupData)spawnGroupData).leader);
        }
    ...
    public static class SchoolSpawnGroupData
        ...
        public final EntityBoidFish leader;

        public SchoolSpawnGroupData(EntityBoidFish boidFish) {
    ...
    static class FishSwimGoal extends RandomSwimmingGoal {
        ...
        public FishSwimGoal(EntityBoidFish boidFish) {
