...
public class EntityBrachiosaurusTeenPart extends PartEntity<EntityBrachiosaurusTeen> {

    private final EntityDimensions size;
    public float scale = 1;

    public EntityBrachiosaurusTeenPart(EntityBrachiosaurusTeen parent, float sizeX, float sizeY) {
        super(parent);
        this.size = EntityDimensions.scalable(sizeX, sizeY);
        this.refreshDimensions();
    }

    public EntityBrachiosaurusTeenPart(EntityBrachiosaurusTeen entityBrachiosaurus, float sizeX, float sizeY, EntityDimensions size) {
