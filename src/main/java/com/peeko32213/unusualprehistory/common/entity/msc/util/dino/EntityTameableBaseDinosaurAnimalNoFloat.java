...
public abstract class EntityTameableBaseDinosaurAnimalNoFloat extends TamableAnimal implements GeoAnimatable, IBookEntity, IHatchableEntity {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private static final EntityDataAccessor<Boolean> HUNGRY = SynchedEntityData.defineId(EntityTameableBaseDinosaurAnimalNoFloat.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> TIME_TILL_HUNGRY = SynchedEntityData.defineId(EntityTameableBaseDinosaurAnimalNoFloat.class, EntityDataSerializers.INT);

    private static final EntityDataAccessor<Boolean> SADDLED = SynchedEntityData.defineId(EntityTameableBaseDinosaurAnimalNoFloat.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> SWINGING = SynchedEntityData.defineId(EntityTameableBaseDinosaurAnimalNoFloat.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> HAS_SWUNG = SynchedEntityData.defineId(EntityTameableBaseDinosaurAnimalNoFloat.class, EntityDataSerializers.BOOLEAN);

    private static final EntityDataAccessor<Integer> PASSIVE = SynchedEntityData.defineId(EntityTameableBaseDinosaurAnimalNoFloat.class, EntityDataSerializers.INT);

    private static final EntityDataAccessor<Boolean> IS_FROM_EGG = SynchedEntityData.defineId(EntityTameableBaseDinosaurAnimalNoFloat.class, EntityDataSerializers.BOOLEAN);
    ...
    private static final EntityDataAccessor<Integer> ANIM_TIMER = SynchedEntityData.defineId(EntityTameableBaseDinosaurAnimalNoFloat.class, EntityDataSerializers.INT);
    public static final Logger LOGGER = LogManager.getLogger();
    private boolean orderedToSit;
    public int attackCooldown = 0;
    int lastTimeSinceHungry;
    public int alertTicks = 0;
    protected EntityTameableBaseDinosaurAnimalNoFloat(EntityType<? extends TamableAnimal> entityType, Level level) {
        ...
        if(hasTargets() && !this.hasControllingPassenger()) {
            this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, false, false, entity -> entity.getType().is(getTargetTag())) {
                        ...
                        public boolean canUse() {
                            return ((EntityTameableBaseDinosaurAnimalNoFloat) this.mob).isHungry() && super.canUse();
                        }
                    }
            );
        }
    ...
    protected PathNavigation createNavigation(Level level) {
        if(hasCustomNavigation()){
            return new EntityTameableBaseDinosaurAnimalNoFloat.DinoCustomNavigation(this, level);
        }
    ...
    static class DinoCustomNavigation extends GroundPathNavigation {
        ...
        protected PathFinder createPathFinder(int p_33382_) {
            this.nodeEvaluator = new EntityTameableBaseDinosaurAnimalNoFloat.CustomNodeEvaluator();
    ...
    public static boolean checkSurfaceDinoSpawnRules(EntityType<? extends EntityTameableBaseDinosaurAnimalNoFloat> p_186238_, LevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource p_186242_) {
