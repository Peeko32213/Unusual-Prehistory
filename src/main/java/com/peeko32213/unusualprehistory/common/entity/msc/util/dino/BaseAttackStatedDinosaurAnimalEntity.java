...
// TODO: new attack ai?
public abstract class BaseAttackStatedDinosaurAnimalEntity extends Animal implements GeoAnimatable, IHatchableEntity, IBookEntity, IStateAction, IAttackStateAction {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    private static final EntityDataAccessor<Boolean> HUNGRY = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> TIME_TILL_HUNGRY = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.INT);

    private static final EntityDataAccessor<Boolean> SADDLED = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> PASSIVE = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> IS_FROM_EGG = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> TRADING = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> FROM_BOOK = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> RANDOM_NUMBER = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> RANDOM_BOOL = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> ANIM_TIMER = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> PERFORMING_ACTION = SynchedEntityData.defineId(BaseAttackStatedDinosaurAnimalEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    protected BaseAttackStatedDinosaurAnimalEntity(EntityType<? extends Animal> entityType, Level level) {
        ...
        if(hasTargets()) {
            this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, false, false, entity -> entity.getType().is(getTargetTag())) {
                        ...
                        public boolean canUse() {
                            return ((BaseAttackStatedDinosaurAnimalEntity) this.mob).isHungry() && super.canUse();
                        }
                    }
            );
        }
    ...
    protected @NotNull PathNavigation createNavigation(@NotNull Level level) {
        if(hasCustomNavigation()){
            return new BaseStatedDinosaurAnimalEntity.DinoCustomNavigation(this, level);
        }
    ...
    static class DinoCustomNavigation extends GroundPathNavigation {
        ...
        protected @NotNull PathFinder createPathFinder(int p_33382_) {
            this.nodeEvaluator = new BaseStatedDinosaurAnimalEntity.CustomNodeEvaluator();
    ...
    public static boolean checkSurfaceDinoSpawnRules(EntityType<? extends BaseStatedDinosaurAnimalEntity> dino, LevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource p_186242_) {
