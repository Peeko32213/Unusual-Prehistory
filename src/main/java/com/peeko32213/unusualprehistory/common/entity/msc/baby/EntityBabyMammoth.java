...
//
//
//public class EntityBabyMammoth extends EntityTameableBaseDinosaurAnimal {
//
...
//    private int age;
//    private static final RawAnimation BABY_WALK = RawAnimation.begin().thenLoop("animation.baby_mammoth.walk");
//    private static final RawAnimation BABY_IDLE = RawAnimation.begin().thenLoop("animation.baby_mammoth.idle");
//    private static final RawAnimation BABY_SWIM = RawAnimation.begin().thenLoop("animation.baby_mammoth.swim");
//
//    public EntityBabyMammoth(EntityType<? extends EntityTameableBaseDinosaurAnimal> entityType, Level level) {
...
//        return EntityBabyMammoth.FOOD_ITEMS.test(stack);
//    }
//
...
//            EntityMammoth frog = UPEntities.MAMMOTH.get().create(this.level());
//            if (frog == null) return;
//
...
//    }
//
//    protected <E extends EntityBabyMammoth> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
//        if (this.isInWater()) {
