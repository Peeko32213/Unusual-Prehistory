 ...
 public class KaprosuchusEntity extends TameableBaseDinosaurAnimalEntity implements CustomFollower, SemiAquatic {
     ...
     public KaprosuchusEntity(EntityType<? extends TameableBaseDinosaurAnimalEntity> entityType, Level level) {
     ...
     protected void registerGoals() {
         ...
         this.goalSelector.addGoal(1, new KaprosuchusEntity.KaproMeleeAttackGoal(this, 1.5F, true));
     ...
     static class KaproMeleeAttackGoal extends Goal {
         ...
         protected final KaprosuchusEntity mob;
         ...
         public KaproMeleeAttackGoal(KaprosuchusEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
             this.mob = p_i1636_1_;
