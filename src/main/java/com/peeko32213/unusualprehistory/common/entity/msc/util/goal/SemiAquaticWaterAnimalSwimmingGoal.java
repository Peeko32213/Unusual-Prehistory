...
public class SemiAquaticWaterAnimalSwimmingGoal extends RandomStrollGoal {

    public SemiAquaticWaterAnimalSwimmingGoal(Animal creature, double speed, int chance) {
    ...
    protected Vec3 getPosition() {
        ...
        for(int i = 0; vector3d != null && !this.mob.level().getFluidState(UPBlockPos.fromVec3(vector3d)).is(FluidTags.LAVA) && !this.mob.level().getBlockState(UPBlockPos.fromVec3(vector3d)).isPathfindable(this.mob.level(), UPBlockPos.fromVec3(vector3d), PathComputationType.WATER) && i++ < 15; vector3d = DefaultRandomPos.getPos(this.mob, 10, 7)) {
        }
