...
public class ProscinetesEntity extends PrehistoricAquaticEntity {
    ...
    private static final EntityDataAccessor<Integer> ANIMATION_STATE = SynchedEntityData.defineId(ProscinetesEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> COMBAT_STATE = SynchedEntityData.defineId(ProscinetesEntity.class, EntityDataSerializers.INT);
