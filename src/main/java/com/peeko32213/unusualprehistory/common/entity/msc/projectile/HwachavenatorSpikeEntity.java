...
public class HwachavenatorSpikeEntity extends Entity implements GeoAnimatable {
    ...
    public HwachavenatorSpikeEntity(EntityType p_i50162_1_, Level p_i50162_2_) {
        super(p_i50162_1_, p_i50162_2_);
    }

    public HwachavenatorSpikeEntity(Level worldIn, HwachavenatorEntity stalker) {
    ...
    public HwachavenatorSpikeEntity(Level worldIn, double x, double y, double z, double p_i47274_8_, double p_i47274_10_, double p_i47274_12_) {
        this(UPEntities.HWACHA_SPIKE.get(), worldIn);
        this.setPos(x, y, z);
        this.setDeltaMovement(p_i47274_8_, p_i47274_10_, p_i47274_12_);
    }

    public HwachavenatorSpikeEntity(PlayMessages.SpawnEntity spawnEntity, Level world) {
    ...
    protected <E extends HwachavenatorSpikeEntity> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
