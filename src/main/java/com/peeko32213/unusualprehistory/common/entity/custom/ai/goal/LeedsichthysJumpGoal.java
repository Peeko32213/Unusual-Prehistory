...
public class LeedsichthysJumpGoal extends JumpGoal {

    private static final int[] STEPS_TO_CHECK = new int[]{0, 1, 4, 5, 6, 7};
    private final LeedsichthysEntity entity;
    private final int interval;
    private boolean breached;

    public LeedsichthysJumpGoal(LeedsichthysEntity pEntity, int pInterval) {
        this.entity = pEntity;
    ...
    public void start() {
        Direction direction = this.entity.getMotionDirection();
        this.entity.setDeltaMovement(this.entity.getDeltaMovement().add((double) direction.getStepX() * 1.7D, 1.15D, (double) direction.getStepZ() * 1.7D));
