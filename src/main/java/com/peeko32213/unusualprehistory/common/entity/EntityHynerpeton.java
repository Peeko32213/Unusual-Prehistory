...
public class EntityHynerpeton extends EntityBaseDinosaurAnimal implements SemiAquatic, GeoEntity {
    ...
    private static final EntityDataAccessor<Boolean> FED_GUNPOWDER = SynchedEntityData.defineId(EntityHynerpeton.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> EXPLODE_TIMER = SynchedEntityData.defineId(EntityHynerpeton.class, EntityDataSerializers.INT);
