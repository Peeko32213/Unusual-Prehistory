...
public class MammothEntity extends BaseDinosaurAnimalEntity implements Shearable, net.minecraftforge.common.IForgeShearable, ContainerListener {
    ...
    private void initMammothInventory() {
        ...
        this.mammothInventory = new SimpleContainer(size) {
            public boolean stillValid(Player player) {
                return MammothEntity.this.isAlive() && !MammothEntity.this.isInsidePortal;
            }
        };
    ...
    private static List<ItemStack> getShearLoot(MammothEntity mammoth) {
    ...
    public class MammothTrunkIdleGoal extends Goal {
        ...
        public MammothTrunkIdleGoal(MammothEntity mammoth) {
    ...
    protected <E extends MammothEntity> PlayState trunkController(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
