...
public class GigantopithicusEntity extends PrehistoricEntityOld implements IVariantEntity {
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel serverLevel, @NotNull AgeableMob ageableMob) {
        return UPEntities.GIGANTOPITHICUS.get().create(serverLevel);
    }
    ...
    static class ApeMeleeAttackGoal extends Goal {
        ...
        public ApeMeleeAttackGoal(GigantopithicusEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
            this.mob = p_i1636_1_;
        ...
        protected void preformSlamAttack() {
            ...
            HitboxAttacks.largeAttack(this.mob.damageSources().mobAttack(mob), 10.0f, 2.5f, mob, pos, 9.0F, -Math.PI / 2, Math.PI / 2, -1.0f, 3.0f, false);
        }
    ...
    protected <E extends GigantopithicusEntity> PlayState sitController(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
        int animState = this.getAnimationState();
