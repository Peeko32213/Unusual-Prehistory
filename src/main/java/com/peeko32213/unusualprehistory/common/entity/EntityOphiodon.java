...
public class EntityOphiodon extends WaterAnimal implements GeoAnimatable, IBookEntity {
    ...
    private static final EntityDataAccessor<Boolean> FROM_BOOK = SynchedEntityData.defineId(EntityOphiodon.class, EntityDataSerializers.BOOLEAN);
    ...
    public EntityOphiodon(EntityType<? extends WaterAnimal> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new EntityOphiodon.OphiodonMeleeAttackGoal(this, 2F, true));
    ...
    static class MoveHelperController extends MoveControl {
        private final EntityOphiodon dolphin;

        public MoveHelperController(EntityOphiodon dolphinIn) {
            super(dolphinIn);
    ...
    static class OphiodonMeleeAttackGoal extends Goal {
        ...
        protected final EntityOphiodon mob;
