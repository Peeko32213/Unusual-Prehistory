...
public class UlughbegsaurusAttackGoal extends Goal {
    ...
    protected final UlughbegsaurusEntity mob;
    ...
    Vec3 biteOffSet = new Vec3(0, 0.3, 1.5);

    public UlughbegsaurusAttackGoal(UlughbegsaurusEntity pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        this.mob = pMob;
    ...
    protected void preformBiteAttack () {
        ...
        HitboxAttacks.pivotedPolyHitCheck(mob, this.mob, this.biteOffSet, 0.7, 1, 1.0, (ServerLevel)this.mob.level(), (float) mob.getAttribute(Attributes.ATTACK_DAMAGE).getValue(), (this.mob.damageSources().mobAttack(mob)), 0.15F, false, true, false);
    }
