...
public class EntityJawlessFish extends EntityBoidFish implements Bucketable, GeoAnimatable, IBookEntity{
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(EntityJawlessFish.class, EntityDataSerializers.INT);
    ...
    public EntityJawlessFish(EntityType<? extends EntityBoidFish> entityType, Level level) {
