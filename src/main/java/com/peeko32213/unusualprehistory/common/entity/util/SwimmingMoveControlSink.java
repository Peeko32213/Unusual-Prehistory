...
public class SwimmingMoveControlSink extends MoveControl {
    private final PathfinderMob entity;
    private float speedMulti;
    private float ySpeedMod = 1;
    private float yawLimit = 10.0F;

    public SwimmingMoveControlSink(PathfinderMob entity, float speedMulti, float ySpeedMod) {
        super(entity);
        this.entity = entity;
    ...
    public SwimmingMoveControlSink(PathfinderMob entity, float speedMulti, float ySpeedMod, float yawLimit) {
        super(entity);
        this.entity = entity;
        this.speedMulti = speedMulti;
        this.ySpeedMod = ySpeedMod;
