 ...
 public class BalaurEntity extends TameableBaseDinosaurAnimalEntity implements CustomFollower {
     ...
     public BalaurEntity(EntityType<? extends TameableBaseDinosaurAnimalEntity> entityType, Level level) {
...
//         );
     ...
     class IMeleeAttackGoal extends MeleeAttackGoal {
         public IMeleeAttackGoal() {
             super(BalaurEntity.this, 1.6D, true);
         }
         ...
         protected void checkAndPerformAttack(LivingEntity enemy, double distToEnemySqr) {
             ...
             if (distToEnemySqr <= d0 && this.getTicksUntilNextAttack() <= 0) {
                 ...
                 ((BalaurEntity) this.mob).setHungry(false);
                 ((BalaurEntity) this.mob).attack(enemy);
                 ((BalaurEntity) this.mob).setTimeTillHungry(mob.getRandom().nextInt(300) + 300);
             }
         }
     ...
     static class BalaurMeleeAttackGoal extends Goal {
         ...
         protected final BalaurEntity mob;
         ...
         public BalaurMeleeAttackGoal(BalaurEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
             this.mob = p_i1636_1_;
