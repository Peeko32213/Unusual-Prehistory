...
public class EntityProtosphyraena extends WaterAnimal implements GeoAnimatable, IBookEntity, PackHunter {
    ...
    private static final EntityDataAccessor<Integer> ENTITY_STATE = SynchedEntityData.defineId(EntityProtosphyraena.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> FROM_BOOK = SynchedEntityData.defineId(EntityProtosphyraena.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> ALPHA = SynchedEntityData.defineId(EntityProtosphyraena.class, EntityDataSerializers.BOOLEAN);
    ...
    public void setPriorPackMember(PackHunter animal) {
        this.priorPackMember = (EntityProtosphyraena) animal;
    }

    @Override
    public void setAfterPackMember(PackHunter animal) {
        this.afterPackMember = (EntityProtosphyraena) animal;
    }
        ...
        if (target != null && target.isAlive() && !(target instanceof Player player && player.isCreative())) {
            if (this.isDominate()) {
                ...
                while (leader.getAfterPackMember() != null) {
                    ...
                    if(!((EntityProtosphyraena) leader).isAlliedTo(target)){
                        ((EntityProtosphyraena) leader).setTarget(target);
                    }
                }
            }
    ...
    static class MoveHelperController extends MoveControl {
        ...
        public MoveHelperController(EntityProtosphyraena dolphinIn) {
            super(dolphinIn);
    ...
    static class OphiodonMeleeAttackGoal extends Goal {
        ...
        protected final EntityProtosphyraena mob;
        ...
        public OphiodonMeleeAttackGoal(EntityProtosphyraena p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
            this.mob = p_i1636_1_;
