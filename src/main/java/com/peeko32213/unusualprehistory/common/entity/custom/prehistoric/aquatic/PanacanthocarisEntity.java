...
public class PanacanthocarisEntity extends PrehistoricAquaticEntity {

    private static final EntityDataAccessor<Integer> ANIMATION_STATE = SynchedEntityData.defineId(PanacanthocarisEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> COMBAT_STATE = SynchedEntityData.defineId(PanacanthocarisEntity.class, EntityDataSerializers.INT);
    ...
    protected <E extends PanacanthocarisEntity> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
