...
public class PrehistoricFollowOwnerGoal extends FollowOwnerGoal {

    private ICustomFollower follower;

    public PrehistoricFollowOwnerGoal(PrehistoricEntity tameable, double speed, float minDist, float maxDist, boolean teleportToLeaves) {
