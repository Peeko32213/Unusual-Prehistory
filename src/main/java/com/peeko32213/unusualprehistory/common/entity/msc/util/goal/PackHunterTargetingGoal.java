...
public class PackHunterTargetingGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
    private final BaseDinosaurAnimalEntity tamableMob;

    public PackHunterTargetingGoal(BaseDinosaurAnimalEntity tamableAnimal, Class<T> clazz, int chance, boolean seeCheck, boolean reachCheck, @Nullable Predicate<LivingEntity> entityPredicate) {
