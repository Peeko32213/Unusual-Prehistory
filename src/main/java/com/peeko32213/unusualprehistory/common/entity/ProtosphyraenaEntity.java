 ...
 public class ProtosphyraenaEntity extends WaterAnimal implements GeoAnimatable, IBookEntity, PackHunter {
     ...
     private static final EntityDataAccessor<Boolean> FROM_BOOK = SynchedEntityData.defineId(ProtosphyraenaEntity.class, EntityDataSerializers.BOOLEAN);
     private static final EntityDataAccessor<Boolean> ALPHA = SynchedEntityData.defineId(ProtosphyraenaEntity.class, EntityDataSerializers.BOOLEAN);

     private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
     private static final RawAnimation PROTOSPHYRAENA_SWIM = RawAnimation.begin().thenLoop("animation.protosphyraena.swim");
     private static final RawAnimation PROTOSPHYRAENA_WATER_IDLE = RawAnimation.begin().thenLoop("animation.protosphyraena.water_idle");
     private static final RawAnimation PROTOSPHYRAENA_ATTACK = RawAnimation.begin().thenLoop("animation.protosphyraena.bite");
     private static final RawAnimation PROTOSPHYRAENA_BEACHED = RawAnimation.begin().thenLoop("animation.protosphyraena.beached");
     ...
     protected void registerGoals() {
         ...
         this.goalSelector.addGoal(1, new ProtosphyraenaEntity.OphiodonMeleeAttackGoal(this, 2F, true));
             ...
             if (this.isDominate()) {
                 ...
                 while (leader.getAfterPackMember() != null) {
                     ...
                     if(!((ProtosphyraenaEntity) leader).isAlliedTo(target)){
                         ((ProtosphyraenaEntity) leader).setTarget(target);
                     }
                 }
             }
     ...
     protected <E extends ProtosphyraenaEntity> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
         ...
         if(this.isFromBook()) {
             ...
             switch (animState) {
                 ...
                 case 21:
                     return event.setAndContinue(PROTOSPHYRAENA_ATTACK);
     ...
     static class MoveHelperController extends MoveControl {
         private final ProtosphyraenaEntity dolphin;

         public MoveHelperController(ProtosphyraenaEntity dolphinIn) {
             super(dolphinIn);
     ...
     static class OphiodonMeleeAttackGoal extends Goal {

         protected final ProtosphyraenaEntity mob;
         ...
         public OphiodonMeleeAttackGoal(ProtosphyraenaEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
             this.mob = p_i1636_1_;
     ...
     public static boolean checkSurfaceWaterDinoSpawnRules(EntityType<? extends ProtosphyraenaEntity> pWaterAnimal, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
