...
public class OpalescentShurikenEntity extends ThrowableItemProjectile {
    private ItemStack toPlaceStack;
    public OpalescentShurikenEntity(EntityType<? extends OpalescentShurikenEntity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public OpalescentShurikenEntity(Level pLevel, LivingEntity pShooter, ItemStack item) {
