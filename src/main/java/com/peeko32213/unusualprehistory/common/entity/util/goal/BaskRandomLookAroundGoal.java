...
import com.peeko32213.unusualprehistory.common.entity.custom.prehistoric.semi_aquatic.TanystropheusEntity;
import net.minecraft.world.entity.ai.goal.Goal;

import java.util.EnumSet;

public class BaskRandomLookAroundGoal extends Goal{
    private final TanystropheusEntity mob;
    private double relX;
    private double relZ;
    private int lookTime;

    public BaskRandomLookAroundGoal(TanystropheusEntity pMob) {
        this.mob = pMob;
