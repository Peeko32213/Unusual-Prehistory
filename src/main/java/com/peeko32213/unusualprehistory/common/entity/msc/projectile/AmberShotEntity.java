...
public class AmberShotEntity extends BetterAbstractHurtingProjectile implements GeoAnimatable {
    ...
    public AmberShotEntity(EntityType<? extends AmberShotEntity> p_i50160_1_, Level p_i50160_2_) {
        super(p_i50160_1_, p_i50160_2_);
    }

    public AmberShotEntity(Level worldIn, LivingEntity shooter, double accelX, double accelY, double accelZ,
                           float directHitDamage) {
        super(UPEntities.AMBER_SHOT.get(), shooter, accelX, accelY, accelZ, worldIn);
        this.directHitDamage = directHitDamage;
    }

    public AmberShotEntity(Level worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
    ...
    protected <E extends AmberShotEntity> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
