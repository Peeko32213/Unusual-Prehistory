...
public class CustomDinoRangedAttackGoal extends Goal {
    private final EntityRangedMeleeBaseDinosaurAnimal entity;
    private double moveSpeedAmp = 1;
    private int attackTime = -1;
    private CustomDinoAbstractRangedAttack attack;
    private boolean multiShot;

    public CustomDinoRangedAttackGoal(EntityRangedMeleeBaseDinosaurAnimal mob, CustomDinoAbstractRangedAttack attack, double moveSpeedAmpIn) {
        this.entity = mob;
    ...
    public CustomDinoRangedAttackGoal(EntityRangedMeleeBaseDinosaurAnimal mob, CustomDinoAbstractRangedAttack attack, double moveSpeedAmpIn, boolean multishot) {
        this.entity = mob;
        this.moveSpeedAmp = moveSpeedAmpIn;
        this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK));
        this.attack = attack;
