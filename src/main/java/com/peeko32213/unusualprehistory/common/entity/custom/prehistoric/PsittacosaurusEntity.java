 ...
 public class PsittacosaurusEntity extends PrehistoricEntity {
     ...
     private static final EntityDataAccessor<Integer> SHEDDING_TIME = SynchedEntityData.defineId(PsittacosaurusEntity.class, EntityDataSerializers.INT);
     private static final EntityDataAccessor<Boolean> SHEDDING = SynchedEntityData.defineId(PsittacosaurusEntity.class, EntityDataSerializers.BOOLEAN);
     ...
     public void tick() {
         ...
         if(this.getIsShedding()) {
             ...
             if (random.nextInt(90) == 0) {
                 this.spawnAtLocation(UPItems.PSITTACOSAURUS_QUILL.get());
             }
         }
     }
     ...
     static class PsittacoMeleeAttackGoal extends Goal {
         ...
         protected final PsittacosaurusEntity mob;
         ...
         public PsittacoMeleeAttackGoal(PsittacosaurusEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
             this.mob = p_i1636_1_;
         ...
         protected void preformSpikeAttack() {
             ...
             HitboxAttacks.largeAttack(this.mob.damageSources().mobAttack(mob), 10.0f, 0.5f, mob, pos, 3.0F, -Math.PI / 2, Math.PI / 2, -1.0f, 3.0f, false);
         }

         protected void preformClawAttack() {
             Vec3 pos = mob.position();
             HitboxAttacks.largeAttack(this.mob.damageSources().mobAttack(mob), 5.0f, 0.2f, mob, pos, 2.0F, -Math.PI / 2, Math.PI / 2, -1.0f, 3.0f, false);
         }
