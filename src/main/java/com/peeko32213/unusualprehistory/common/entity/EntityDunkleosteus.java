...
public class EntityDunkleosteus extends WaterAnimal implements IAnimatable, NeutralMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(0, new EntityDunkleosteus.IMeleeAttackGoal());
