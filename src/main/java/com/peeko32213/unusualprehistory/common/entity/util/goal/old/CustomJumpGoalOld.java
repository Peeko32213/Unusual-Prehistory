package com.peeko32213.unusualprehistory.common.entity.util.goal.old;
...
public class CustomJumpGoalOld extends JumpGoal {
    private static final int[] STEPS_TO_CHECK = new int[]{0, 1, 4, 5, 6, 7};
    private final PrehistoricAquaticEntityOld dolphin;
    private final int interval;
    private boolean breached;

    public CustomJumpGoalOld(PrehistoricAquaticEntityOld pDolphin, int pInterval) {
