 ...
 import com.peeko32213.unusualprehistory.common.entity.custom.ai.goal.BaskRandomLookAroundGoal;
 ...
 public class TanystropheusEntity extends PrehistoricEntityOld implements ISemiAquatic {
     ...
     protected void registerGoals() {
         ...
         this.goalSelector.addGoal(7, new LookAtPlayerGoal(this, Player.class, 6.0F)
         {
             @Override
             public boolean canUse() {
                 if(this.mob instanceof TanystropheusEntity entityTanystropheus)
                 {
     ...
     public boolean hurt(@NotNull DamageSource source, float amount) {
         ...
         if (prev) {
             double range = 15;
             List<? extends TanystropheusEntity> list = this.level().getEntitiesOfClass(this.getClass(), this.getBoundingBox().inflate(range, range / 2, range));
             for (TanystropheusEntity gaz : list) {
     ...
     protected <E extends TanystropheusEntity> PlayState baskController(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
