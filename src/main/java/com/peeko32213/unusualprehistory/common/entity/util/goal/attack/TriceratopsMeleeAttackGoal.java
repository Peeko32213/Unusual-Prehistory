...
public class TriceratopsMeleeAttackGoal extends Goal {
    ...
    private final int meleeRange = 200;
    ...
    protected void tickChargeAttack () {
        ...
        if(animTime >= 19 && animTime < 38) {
            ...
            HitboxAttacks.pivotedPolyHitCheck(this.mob, this.chargeOffSet, 1.3, 3, 1.2, (ServerLevel) this.mob.level(), (float) mob.getAttribute(Attributes.ATTACK_DAMAGE).getValue() / 2, this.mob.damageSources().mobAttack(mob), 4, true, false);
        }
    ...
    protected void preformStrikeAttack () {
        ...
        HitboxAttacks.pivotedPolyHitCheck(this.mob, this.strikeOffSet, 1.3, 2, 1.4, (ServerLevel)this.mob.level(), (float) mob.getAttribute(Attributes.ATTACK_DAMAGE).getValue(), (this.mob.damageSources().mobAttack(mob)), 1.5F, false, false);
    }
