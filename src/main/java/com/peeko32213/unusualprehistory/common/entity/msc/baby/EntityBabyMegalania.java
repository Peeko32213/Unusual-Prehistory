...
public class EntityBabyMegalania extends EntityTameableBaseDinosaurAnimal implements IAnimatable {
    ...
    public boolean isFood(ItemStack stack) {
        return EntityBabyMegalania.FOOD_ITEMS.test(stack);
    }
    ...
    public void registerControllers(AnimationData data) {
        ...
        AnimationController<EntityBabyMegalania> controller = new AnimationController<>(this, "controller", 5, this::predicate);
