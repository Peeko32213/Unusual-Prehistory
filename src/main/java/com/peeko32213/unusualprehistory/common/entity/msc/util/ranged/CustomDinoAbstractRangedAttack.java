...
public abstract class CustomDinoAbstractRangedAttack implements IRangedAttack {

    public EntityRangedMeleeBaseDinosaurAnimal parentEntity;
    ...
    public CustomDinoAbstractRangedAttack(EntityRangedMeleeBaseDinosaurAnimal parentEntity) {
        this.parentEntity = parentEntity;
    }

    public CustomDinoAbstractRangedAttack(EntityRangedMeleeBaseDinosaurAnimal parentEntity, double xOffSetModifier, double entityHeightFraction,
    ...
    public CustomDinoAbstractRangedAttack setProjectileOriginOffset(double x, double entityHeightFraction, double z) {
        xOffSetModifier = x;
        this.entityHeightFraction = entityHeightFraction;
        zOffSetModifier = z;
        return this;
    ...
    public CustomDinoAbstractRangedAttack setDamage(float damage) {
        this.damage = damage;
        return this;
    }
    ...
    public CustomDinoAbstractRangedAttack setSound(AttackSound sound) {
        this.sound = sound;
        return this;
    }

    public CustomDinoAbstractRangedAttack setSound(SoundEvent sound, float volume, float pitch) {
        this.sound = new AttackSound(sound, volume, pitch);
        return this;
    }

    public CustomDinoAbstractRangedAttack setAccuracy(double accuracy) {
