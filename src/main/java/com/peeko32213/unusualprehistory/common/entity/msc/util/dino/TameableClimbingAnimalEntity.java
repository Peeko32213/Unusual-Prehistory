...
public abstract class TameableClimbingAnimalEntity extends TameableBaseDinosaurAnimalEntity {
    private static final EntityDataAccessor<Byte> CLIMB_FLAG = SynchedEntityData.defineId(TameableClimbingAnimalEntity.class, EntityDataSerializers.BYTE);

    protected TameableClimbingAnimalEntity(EntityType<? extends TameableBaseDinosaurAnimalEntity> entityType, Level level) {
