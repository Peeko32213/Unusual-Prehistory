...
public abstract class EntityTameableClimbingAnimal extends EntityTameableBaseDinosaurAnimal {
    private static final EntityDataAccessor<Byte> CLIMB_FLAG = SynchedEntityData.defineId(EntityTameableClimbingAnimal.class, EntityDataSerializers.BYTE);

    protected EntityTameableClimbingAnimal(EntityType<? extends EntityTameableBaseDinosaurAnimal> entityType, Level level) {
