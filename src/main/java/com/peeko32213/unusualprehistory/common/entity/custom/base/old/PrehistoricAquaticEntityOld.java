...
public abstract class PrehistoricAquaticEntityOld extends WaterAnimal implements GeoAnimatable, IBookEntity, IHatchableEntity {
    ...
    private static final EntityDataAccessor<Boolean> SADDLED = SynchedEntityData.defineId(PrehistoricAquaticEntityOld.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> PASSIVE = SynchedEntityData.defineId(PrehistoricAquaticEntityOld.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> FROM_BOOK = SynchedEntityData.defineId(PrehistoricAquaticEntityOld.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(PrehistoricAquaticEntityOld.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> RANDOM_NUMBER = SynchedEntityData.defineId(PrehistoricAquaticEntityOld.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> RANDOM_BOOL = SynchedEntityData.defineId(PrehistoricAquaticEntityOld.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> ANIM_TIMER = SynchedEntityData.defineId(PrehistoricAquaticEntityOld.class, EntityDataSerializers.INT);

    int lastTimeSinceHungry;
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public PrehistoricAquaticEntityOld(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        this.moveControl = new PrehistoricAquaticEntityOld.MoveHelperController(this);
    }
        ...
        if(hasTargets()) {
            this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, false, false, entity -> entity.getType().is(getTargetTag())) {
                        ...
                        public boolean canUse() {
                            return ((PrehistoricAquaticEntityOld) this.mob).isHungry() && super.canUse();
                        }
                    }
            );
        }
    ...
    static class MoveHelperController extends MoveControl {
        private final PrehistoricAquaticEntityOld dolphin;

        public MoveHelperController(PrehistoricAquaticEntityOld dolphinIn) {
            super(dolphinIn);
