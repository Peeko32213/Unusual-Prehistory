...
import com.peeko32213.unusualprehistory.common.entity.projectile.OpalescentPearlEntity;
...
public class OpalescentPearlItem extends Item {
    public OpalescentPearlItem(Item.Properties pProperties) {
        super(pProperties);
    }
