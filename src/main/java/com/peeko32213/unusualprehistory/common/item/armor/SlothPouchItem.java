...
public class SlothPouchItem extends ArmorItem implements GeoItem {
     ...
     * **/
    public SlothPouchItem(ArmorMaterial material, ArmorItem.Type slot, int tameTime, Properties settings) {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (tag.contains("megatherium") && pHand == InteractionHand.MAIN_HAND) {
            if(!pLevel.isClientSide) {
                MegatheriumEntity babyMegatherium = UPEntities.MEGATHERIUM.get().create(pLevel);
    ...
    public ItemStack addTag(ItemStack stack, Level level){
        CompoundTag tag = stack.getTag();
        MegatheriumEntity entityBabyMegatherium = UPEntities.MEGATHERIUM.get().create(level);
