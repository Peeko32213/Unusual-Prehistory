...
public class UnusualPrehistoryConfig {
    ...
    public static ForgeConfigSpec.ConfigValue<Boolean> SCREEN_SHAKE_PARACERATHERIUM;
    public static ForgeConfigSpec.ConfigValue<Double> SCREEN_SHAKE_PARACERATHERIUM_RANGE;
    public static ForgeConfigSpec.ConfigValue<Integer> SCREEN_SHAKE_PARACERATHERIUM_AMPLIFIER;
    ...
    public static ForgeConfigSpec.ConfigValue<Float> PARACERATHERIUM_SOUND_VOLUME;
