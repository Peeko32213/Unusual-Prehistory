        ...
        public static void handle(UPMessageHurtMultipart message, Supplier<NetworkEvent.Context> context) {
            ...
            if (player != null) {
                if (player.level != null) {
                    ...
                    if(part instanceof HurtableMultipart && parent instanceof LivingEntity){
                        ((HurtableMultipart) part).onAttackedFromServer((LivingEntity)parent, message.damage, new DamageSource(message.damageType));
                    }
