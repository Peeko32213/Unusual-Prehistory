...
public class UPPaintingTagsProvider extends PaintingVariantTagsProvider {

    public UPPaintingTagsProvider(PackOutput packOutput, CompletableFuture<Provider> lookupProvider, ExistingFileHelper helper) {
