...
public class UPTags {
    ...
    // Velociraptor tags
    public static final TagKey<Block> VELOCI_BUTTONS = registerBlockTag("velociraptor_buttons");
    ...
    public static final TagKey<Item> ZULOAGAE_ITEM = registerItemTag("zuloagae");
