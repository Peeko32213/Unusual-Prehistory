...
public class UPAdvancementTrigger extends SimpleCriterionTrigger<UPAdvancementTrigger.Instance> {
    ...
    public UPAdvancementTrigger.Instance createInstance(JsonObject p_230241_1_, EntityPredicate.Composite p_230241_2_, DeserializationContext p_230241_3_) {
        return new UPAdvancementTrigger.Instance(p_230241_2_, resourceLocation);
    }
