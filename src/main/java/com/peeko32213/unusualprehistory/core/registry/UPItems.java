...
public class UPItems {
    ...
    public static final RegistryObject<ForgeSpawnEggItem> PANACANTHOCARIS_EGG = registerSpawnEggs("panacanthocaris_spawn_egg", UPEntities.PANACANTHOCARIS , 0x16181a, 0xefee49);
