...
public class UPItems {
    ...
    // Spawn eggs
    public static final RegistryObject<ForgeSpawnEggItem> AMMON_EGG = registerSpawnEggs("ammonite_spawn_egg", UPEntities.AMMON , 0x402018, 0x99895c);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> ANURO_EGG = registerSpawnEggs("anurognathus_spawn_egg", UPEntities.ANURO , 0x7d7968, 0xf4dd48);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> CORONODON_EGG = registerSpawnEggs("coronodon_spawn_egg", UPEntities.CORONODON , 0x1a2c58, 0xeaf77e);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> ESTEMMENOSUCHUS_EGG = registerSpawnEggs("estemmenosuchus_spawn_egg", UPEntities.ESTEMMENOSUCHUS , 0x1e202d, 0x7e4995);
    public static final RegistryObject<ForgeSpawnEggItem> GIGANTO_EGG = registerSpawnEggs("gigantopithecus_spawn_egg", UPEntities.GIGANTOPITHICUS , 0x7c3c23, 0x665f58);
    public static final RegistryObject<ForgeSpawnEggItem> GLOBIDENS_EGG = registerSpawnEggs("globidens_spawn_egg", UPEntities.GLOBIDENS , 0x414f4a, 0xdbe4e1);
    public static final RegistryObject<ForgeSpawnEggItem> GUANLINGSAURUS_EGG = registerSpawnEggs("guanlingsaurus_spawn_egg", UPEntities.GUANLINGSAURUS , 0x4a7f88, 0xeef37a);
    public static final RegistryObject<ForgeSpawnEggItem> HWACHA_EGG = registerSpawnEggs("hwachavenator_spawn_egg", UPEntities.HWACHA , 0x314940, 0xe6d53c);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> KAPROSUCUHS_EGG = registerSpawnEggs("kaprosuchus_spawn_egg", UPEntities.KAPROSUCHUS , 0x322f2c, 0xf6f050);
    public static final RegistryObject<ForgeSpawnEggItem> KENTRO_EGG = registerSpawnEggs("kentrosaurus_spawn_egg", UPEntities.KENTRO , 0x122407, 0xddcca4);
    public static final RegistryObject<ForgeSpawnEggItem> KIMMER_EGG = registerSpawnEggs("kimmeridgebrachypteraeschnidium_spawn_egg", UPEntities.KIMMER , 0x233213, 0xd2aa25);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> PACHY_EGG = registerSpawnEggs("pachycephalosaurus_spawn_egg", UPEntities.PACHY , 0x852d2d, 0xf8b209);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> PANACANTHOCARIS_EGG = registerSpawnEggs("panacanthocaris_spawn_egg", UPEntities.PANACANTHOCARIS , 0xc9d0d4, 0xefee49);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> PROSCINETES_EGG = registerSpawnEggs("proscinetes_spawn_egg", UPEntities.PROSCINETES , 0x600e76, 0xf3c33a);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> SCHLUMBERGERITES_EGG = registerSpawnEggs("schlumbergerites_spawn_egg", UPEntities.SCHLUMBERGERITES , 0xf4fbf9, 0x14eaa5);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> STETHA_EGG = registerSpawnEggs("stethacanthus_spawn_egg", UPEntities.STETHACANTHUS , 0x853028, 0xffc400);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> TITANONARKE_EGG = registerSpawnEggs("titanonarke_spawn_egg", UPEntities.TITANONARKE , 0xd6b67a, 0xffffff);
    ...
    public static final RegistryObject<ForgeSpawnEggItem> ULUG_EGG = registerSpawnEggs("ulughbegsaurus_spawn_egg", UPEntities.ULUG , 0x6e5953, 0x466dc2);
    ...
    public static final RegistryObject<Item> BARINA_WHISTLE = ITEMS.register("barina_whistle", () -> new MusicalTameItem(new Item.Properties().stacksTo(1), UPEntities.BARINASUCHUS, UPTags.OCARINA_WHISTLE));
