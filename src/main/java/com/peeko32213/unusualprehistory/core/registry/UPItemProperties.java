...
public class UPItemProperties {
    ...
    private static void makeFruitLootBox(Item item) {
        ItemProperties.register(item, new ResourceLocation("loot_box"), (itemStack, clientLevel, livingEntity, nr) -> BlockFruitLootBox.getCustomModelData(itemStack.getOrCreateTag()));
    }
