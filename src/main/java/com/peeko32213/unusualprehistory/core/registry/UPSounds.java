...
public class UPSounds {
    ...
    public static final RegistryObject<SoundEvent> COTY_IDLE = createSoundEvent("cotylorhynchus_idle");
    public static final RegistryObject<SoundEvent> COTY_HURT = createSoundEvent("cotylorhynchus_hurt");
    public static final RegistryObject<SoundEvent> COTY_DEATH = createSoundEvent("cotylorhynchus_death");
    public static final RegistryObject<SoundEvent> COTY_BURP = createSoundEvent("cotylorhynchus_burp");
    ...
    public static final RegistryObject<SoundEvent> UNICORN_DEATH = createSoundEvent("unicorn_death");
    ...
    public static final RegistryObject<SoundEvent> TYRANNO_AGGRO = createSoundEvent("tyrannosaurus_aggressive");
    ...
    public static final RegistryObject<SoundEvent> TRIKE_DEATH = createSoundEvent("triceratops_death");
    ...
    public static final RegistryObject<SoundEvent> NYCTORAPTOR_IDLE = createSoundEvent("nyctoraptor_idle");
    ...
    public static final RegistryObject<SoundEvent> BALAUR_IDLE = createSoundEvent("balaur_idle");
