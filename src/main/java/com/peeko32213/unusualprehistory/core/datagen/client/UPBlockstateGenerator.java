...
import com.peeko32213.unusualprehistory.core.other.UPBlockFamilies;
...
public class UPBlockstateGenerator extends BlueprintBlockStateProvider {

    public UPBlockstateGenerator(PackOutput output, ExistingFileHelper helper) {
        super(output, UnusualPrehistory.MODID, helper);
    }
    ...
    public void leafBlock(RegistryObject<Block> leaves, boolean tinted) {
    ...
    protected void registerStatesAndModels() {
        ...
        // Dryophyllum wood
        this.blockFamily(UPBlockFamilies.DRYO_PLANKS_FAMILY);
        this.logBlocks(DRYO_LOG, DRYO_WOOD);
        this.logBlocks(STRIPPED_DRYO_LOG, STRIPPED_DRYO_WOOD);
        this.hangingSignBlocks(STRIPPED_DRYO_LOG, DRYO_HANGING_SIGNS);
        this.leafBlock(DRYO_LEAVES, false);
        this.crossBlockWithPot(DRYO_SAPLING, POTTED_DRYO_SAPLING);

        // Foxxi wood
        this.blockFamily(UPBlockFamilies.FOXII_PLANKS_FAMILY);
        this.logBlocks(FOXII_LOG, FOXII_WOOD);
        this.logBlocks(STRIPPED_FOXII_LOG, STRIPPED_FOXII_WOOD);
        this.hangingSignBlocks(STRIPPED_FOXII_LOG, FOXII_HANGING_SIGNS);
        this.leafBlock(FOXII_LEAVES, false);
