...
public class UPBlockLootTables extends BlockLootSubProvider {
    private final Set<Block> knownBlocks = new HashSet<>();
    private static final LootItemCondition.Builder HAS_SILK_TOUCH = MatchTool.toolMatches(ItemPredicate.Builder.item().hasEnchantment(new EnchantmentPredicate(Enchantments.SILK_TOUCH, MinMaxBounds.Ints.atLeast(1))));
    private static final LootItemCondition.Builder HAS_NO_SILK_TOUCH = HAS_SILK_TOUCH.invert();
    public UPBlockLootTables() {
    ...
    protected void generate() {
        ...
        dropSelf(UPBlocks.FOXII_WOOD.get());
        dropSelf(UPBlocks.FOXII_LOG.get());
        dropSelf(UPBlocks.FOXII_FENCE_GATE.get());
        dropSelf(UPBlocks.FOXII_BUTTON.get());
        dropSelf(UPBlocks.FOXII_FENCE.get());
        dropSelf(UPBlocks.FOXII_SLAB.get());
        dropSelf(UPBlocks.FOXII_PRESSURE_PLATE.get());
        dropSelf(UPBlocks.STRIPPED_FOXII_WOOD.get());
        dropSelf(UPBlocks.STRIPPED_FOXII_LOG.get());
        dropSelf(UPBlocks.FOXII_PLANKS.get());
        dropSelf(UPBlocks.FOXII_STAIRS.get());
        dropSelf(UPBlocks.FOXII_TRAPDOOR.get());
