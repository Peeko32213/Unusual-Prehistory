...
public class UPItemTagsGenerator extends ItemTagsProvider {
    public UPItemTagsGenerator(PackOutput p_275343_, CompletableFuture<HolderLookup.Provider> p_275729_,
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        ...
        tag(ItemTags.LEAVES)
                .add(UPBlocks.FOXII_LEAVES.get().asItem())
        ...
        tag(UPTags.FOXXI)
                .add(UPBlocks.FOXII_LOG.get().asItem())
                .add(UPBlocks.FOXII_WOOD.get().asItem())
                .add(UPBlocks.STRIPPED_FOXII_WOOD.get().asItem())
                .add(UPBlocks.STRIPPED_FOXII_LOG.get().asItem())
        ;
        ...
        tag(ItemTags.PLANKS)
                ...
                .add(UPBlocks.FOXII_PLANKS.get().asItem())
        ...
        tag(ItemTags.WOODEN_FENCES)
                ...
                .add(UPBlocks.FOXII_FENCE.get().asItem())
        ...
        tag(ItemTags.WOODEN_DOORS)
                ...
                .add(UPBlocks.FOXII_DOOR.get().asItem())
        ...
        tag(ItemTags.WOODEN_SLABS)
                ...
                .add(UPBlocks.FOXII_SLAB.get().asItem())
        ...
        tag(ItemTags.WOODEN_STAIRS)
                ...
                .add(UPBlocks.FOXII_STAIRS.get().asItem())
        ...
        tag(ItemTags.WOODEN_PRESSURE_PLATES)
                ...
                .add(UPBlocks.FOXII_PRESSURE_PLATE.get().asItem())
        ...
        tag(ItemTags.WOODEN_TRAPDOORS)
                ...
                .add(UPBlocks.FOXII_TRAPDOOR.get().asItem())
        ...
        tag(ItemTags.BUTTONS)
                ...
                .add(UPBlocks.FOXII_BUTTON.get().asItem())
