...
public class UPInstrumentTagsGenerator extends TagsProvider<Instrument> {

    public UPInstrumentTagsGenerator(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pLookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
