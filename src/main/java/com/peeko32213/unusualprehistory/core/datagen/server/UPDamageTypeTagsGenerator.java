...
public class UPDamageTypeTagsGenerator extends TagsProvider<DamageType> {

    public UPDamageTypeTagsGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> future, ExistingFileHelper helper) {
