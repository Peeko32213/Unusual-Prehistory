...
public class BookPageButton extends Button {
    ...
    private AbstractBookScreen bookGUI;

    public BookPageButton(AbstractBookScreen bookGUI, int p_i51079_1_, int p_i51079_2_, boolean p_i51079_3_, OnPress p_i51079_4_, boolean p_i51079_5_) {
