...
public class AustroBootsModel extends AnimatedGeoModel<ItemAustroBoots> {
    @Override
    public ResourceLocation getModelResource(ItemAustroBoots object) {
        return new ResourceLocation(UnusualPrehistory.MODID, "geo/austro_boots.geo.json");

    }

    @Override
    public ResourceLocation getTextureResource(ItemAustroBoots object) {
        return new ResourceLocation(UnusualPrehistory.MODID, "textures/armor/austro_boots.png");
    }

    @Override
    public ResourceLocation getAnimationResource(ItemAustroBoots animatable) {
        return null;
    }
