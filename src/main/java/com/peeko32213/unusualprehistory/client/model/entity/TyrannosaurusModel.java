...
public class TyrannosaurusModel extends GeoModel<TyrannosaurusEntity> {
    ...
    public void setCustomAnimations(TyrannosaurusEntity entity, long instanceId, AnimationState<TyrannosaurusEntity> animationState) {
        ...
        tail2.setRotY((float) (Mth.PI - (MathHelpers.LerpDegrees((float) entity.rexIK.getCurrentTailYaws()[1], (float) entity.rexIK.getTailYaws()[1], 0.01))));
        ...
        tail.setRotX((float) (MathHelpers.LerpDegrees((float) entity.rexIK.getCurrentTailPitches()[0], (float) entity.rexIK.getTailPitches()[0], 0.01)));
        tail2.setRotX((float) (MathHelpers.LerpDegrees((float) entity.rexIK.getCurrentTailPitches()[1], (float) entity.rexIK.getTailPitches()[1], 0.01)));
