...
public class BrachiosaurusTeenModel extends GeoModel<EntityBrachiosaurusTeen>
{
    @Override
    ...
    {
        return new ResourceLocation(UnusualPrehistory.MODID, "animations/brachi_teen.animation.json");
    }
