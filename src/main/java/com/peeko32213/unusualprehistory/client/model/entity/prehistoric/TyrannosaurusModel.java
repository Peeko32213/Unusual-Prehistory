...
//        eyes.setHidden(!entity.hasEepy());
        ...
        tail.setRotY((float) (MathHelpers.angleClamp(MathHelpers.LerpDegrees((float) entity.rexIK.getCurrentTailYaws()[0], (float) entity.rexIK.getTailYaws()[0], 0.01), Mth.HALF_PI)));
        tail2.setRotY((float) (MathHelpers.angleClamp(MathHelpers.LerpDegrees((float) entity.rexIK.getCurrentTailYaws()[1], (float) entity.rexIK.getTailYaws()[1], 0.01), Mth.HALF_PI)));
