...
import com.peeko32213.unusualprehistory.common.entity.custom.prehistoric.semi_aquatic.KaprosuchusEntity;
...
public class KaprosuchusModel extends ExtendedMolangQueriesModel<KaprosuchusEntity> {
    @Override
    ...
    public void setCustomAnimations(KaprosuchusEntity animatable, long instanceId, AnimationState<KaprosuchusEntity> animationState) {
        ...
        CoreGeoBone head = this.getAnimationProcessor().getBone("Kapro_Head");
