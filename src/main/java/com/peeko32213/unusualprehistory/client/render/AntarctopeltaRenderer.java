...
public class AntarctopeltaRenderer extends GeoEntityRenderer<EntityAntarctopelta> {

    public AntarctopeltaRenderer(EntityRendererProvider.Context context) {
        super(context, new AntarctopeltaModel());
    }

    @Override
    public void renderEarly(EntityAntarctopelta animatable, PoseStack stackIn, float ticks, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float partialTicks) {
