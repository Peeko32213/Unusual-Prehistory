...
public class TameableStatedDinosaurRenderer<T extends TameableBaseStatedDinosaurAnimalEntity> extends GeoEntityRenderer<T> {


    public TameableStatedDinosaurRenderer(EntityRendererProvider.Context renderManager, GeoModel<T> modelProvider) {
