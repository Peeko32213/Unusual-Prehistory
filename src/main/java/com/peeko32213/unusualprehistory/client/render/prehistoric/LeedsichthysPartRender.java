...
import com.peeko32213.unusualprehistory.client.model.entity.prehistoric.aquatic.LeedsichthysPartModel;
...
public class LeedsichthysPartRender extends GeoEntityRenderer<LeedsichthysPartEntity> {
    ...
    public boolean shouldShowName(@NotNull LeedsichthysPartEntity entity) {
