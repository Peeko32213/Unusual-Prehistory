...
public class ThrowableFallingBlockRenderer extends EntityRenderer<ThrowableFallingBlockEntity> {
    ...
    public void render(ThrowableFallingBlockEntity pEntity, float pEntityYaw, float pPartialTicks, @NotNull PoseStack pMatrixStack, @NotNull MultiBufferSource pBuffer, int pPackedLight) {
     ...
     */
    public @NotNull ResourceLocation getTextureLocation(@NotNull ThrowableFallingBlockEntity pEntity) {
