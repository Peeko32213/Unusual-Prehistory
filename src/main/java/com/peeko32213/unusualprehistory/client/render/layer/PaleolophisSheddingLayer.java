...
public class PaleolophisSheddingLayer extends GeoLayerRenderer<EntityPalaeophis> {
    private static final ResourceLocation OVERLAY = new ResourceLocation(UnusualPrehistory.MODID, "textures/entity/palaeophis_shed.png");
    private static final ResourceLocation MODEL = new ResourceLocation(UnusualPrehistory.MODID, "geo/palaeophis.geo.json");

    public PaleolophisSheddingLayer(IGeoRenderer<EntityPalaeophis> entityRendererIn) {
