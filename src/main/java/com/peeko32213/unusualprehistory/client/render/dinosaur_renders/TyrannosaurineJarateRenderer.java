...
public class TyrannosaurineJarateRenderer extends GeoProjectilesRenderer<EntityTyrannosaurineJarate> {
    public TyrannosaurineJarateRenderer(EntityRendererProvider.Context context) {
        super(context, new TyrannosaurineJarateModel());
    }
    ...
    @Override
    public void renderEarly(EntityTyrannosaurineJarate animatable, PoseStack stackIn, float ticks,
