...
public class RabiesFlaskRenderer extends GeoEntityRenderer<RabiesFlaskEntity> {
    public RabiesFlaskRenderer(EntityRendererProvider.Context context) {
        super(context, new DefaultModel<>(ModelLocations.RABIES));
    }

    public RenderType getRenderType(RabiesFlaskEntity animatable, float partialTicks, PoseStack stack,
