...
public class PrehistoricSaddleLayer<T extends PrehistoricEntityOld> extends GeoRenderLayer<T> {
    private final ResourceLocation overlayLocation;
    private final ResourceLocation modelLocation;

    //private final GeoModel model;
    public PrehistoricSaddleLayer(GeoRenderer<T> entityRendererIn, ResourceLocation overlayLocation, ResourceLocation modelLocation) {
